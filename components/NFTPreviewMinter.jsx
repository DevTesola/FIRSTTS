 ...
 */
export default function NFTPreviewMinter({ mintPrice = "3 SOL", onMint, loading = false }) {
  ...
  {nft.videoUrl ? (
    ...
    />
          ...
          <div className="mt-8 text-center">
            <p className="mb-2 text-lg font-medium text-gray-300">View more and start minting!</p>
            <button
              onClick={onMint}
              className="mint-button inline-flex items-center justify-center bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 px-8 py-3 rounded-lg"
            >
              <>
                Return to Page
