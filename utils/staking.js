/**
 * Centralized staking utilities module for TESOLA
 * This module contains all constants and functions related to TESOLA staking
 */

import { createClient } from '@supabase/supabase-js';

// Constants for all staking-related paths and values
export const STAKING_PROGRAM_ADDRESS = '4SfUyQkbeyz9jeJDsR5XiUf8DATVZJXtGG4JUsYsWzTs';

// Correct instruction discriminators from IDL
export const STAKE_NFT_DISCRIMINATOR = [38, 27, 66, 46, 69, 65, 151, 219];
export const UNSTAKE_NFT_DISCRIMINATOR = [17, 182, 24, 211, 101, 138, 50, 163];

// PDA seeds
export const ESCROW_SEED = [101, 115, 99, 114, 111, 119]; // "escrow"
export const STAKE_SEED = [115, 116, 97, 107, 101]; // "stake"
export const USER_STAKING_SEED = [117, 115, 101, 114, 95, 115, 116, 97, 107, 105, 110, 103]; // "user_staking"
