...
/**
 * emergency_unstake_nft 명령어 데이터 생성 헬퍼 함수 (인자 없음)
 * @returns {Buffer} 명령어 데이터 버퍼
 */
export function createEmergencyUnstakeNftInstructionData() {
  return createInstructionData('EMERGENCY_UNSTAKE_NFT');
}
